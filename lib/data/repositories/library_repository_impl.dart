...
class LibraryRepositoryImpl implements LibraryRepository {
  ...
  Future<List<LibraryBookEntity>> getUserLibrary() async {
    final data = await _api.get('/library/') as List<dynamic>;
    return data
  ...
  /// Toggle favorite — PATCH /library/{id}/
  ...
  /// Remove book from library — DELETE /library/{id}/
  Future<void> removeBook(String userBookId) async {
    await _api.delete('/library/$userBookId/');
  }

  /// Update reading progress — PATCH /library/{id}/
