                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                               Text('Chapters', style: TextStyle(color: Colors.white, fontSize: context.responsive.sp(18), fontWeight: FontWeight.bold)),
                                  ...
                                  child: bookDetailsAsync.when(
                                      data: (book) {
                                         return chaptersAsync.when(
                                            data: (chapters) => ChapterHeaderCard(book: book, chapters: chapters),
                               ...
                               data: (chapters) => SliverPadding(
                                   ...
                                   sliver: SliverList(
                                      delegate: SliverChildBuilderDelegate(
                                         (context, index) => ChapterListItem(chapter: chapters[index], bookId: bookId),
